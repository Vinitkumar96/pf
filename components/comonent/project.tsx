...
const Project = () => {
  return (
    <div className="w-full ">
      ...
      <div className="grid md:grid-cols-2 gap-9 p-4 border-2 border-neutral-700/50 rounded-xl ">
        {projects.map((project, i) => {
          return (
            <div key={i} className="  w-full  border border-neutral-700 rounded-2xl cursor-pointer hover:bg-gray-700/10 hover: transition-colors ">
              <div className="w-full ">
                <Image
              ...
              <div>
                ...
                <div className="mb-1 px-2  pb-1">
                  <p className="mb-1 text-neutral-400 roboto-slab text-sm ">{project.about}</p>
